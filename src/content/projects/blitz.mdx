...
I didn't touch FE much, but I kept bringing up issues and need of taking proper care of it. The frontend team decided to rewrite everything in Svelte. It ended up being a great success! 

A few things I did change myself:
...
- Pushed for reducing the number of chunks per page-some pages required **700 chunks** to render, with some components billing per-request this was a money burning machine.
