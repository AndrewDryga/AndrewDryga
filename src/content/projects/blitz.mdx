...
- Removed large headers in generated JS chunks (at 300 chunks per page and our request volume, those headers were costing real money);
...
3. **Fixing root causes** - Upscaling databases is easy, but designing with database in mind or at least fixing bad queries is what actually works;
